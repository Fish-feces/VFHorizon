...
class VideoDetailView(View):
    def get(self,request,video_id):
        ...
        comments = VideoComments.objects.filter(video=video_id).order_by('-add_time')
    ...
    def post(self,request,video_id):
        ...
        for comment in comments:
            ...
            data['add_time'] = add_time.strftime('%Y')+'年'+add_time.strftime('%m')+'月'+add_time.strftime('%d')+'日'+add_time.strftime(' %H:%M')
